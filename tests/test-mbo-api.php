...
class Tests_MBO_Api extends MZMBO_WPUnitTestCase
{
    ...
    public function test_get_access_token()
    {
        ...
        $this->assertTrue(class_exists('MzMindbody\Inc\Libraries\MboV6Api'));

        $basic_options = get_option('mz_mbo_basic');

        $mbo_api = new MzMindbody\Inc\Libraries\MboV6Api($basic_options);
        ...
        $bad_mbo_api = new MzMindbody\Inc\Libraries\MboV6Api($bad_basic_options);
