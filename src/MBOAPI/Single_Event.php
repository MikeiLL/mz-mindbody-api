...
class Single_event {
	...
	public function __construct($class, 
		...
		if(!in_array('duration', $hide) && ($class['IsCanceled'] != 1)){
			$this->classStartTime = new \DateTime($class['StartDateTime'], Schedule_Operations::Schedule_Operations::get_blog_timezone());
			$this->classEndTime = new \DateTime($class['EndDateTime'], Schedule_Operations::Schedule_Operations::get_blog_timezone());
			if (phpversion() >= 5.3) {
