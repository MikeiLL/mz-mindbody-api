...
class Display extends Interfaces\ShortcodeScriptLoader {
    ...
    public function handle_shortcode( $atts, $content = null ) {
        ...
        $this->template_data = array(
            ...
            'heading_date'         => __( 'Date', 'mz-mindbody-api' ),
            'heading_time'         => __( 'Time', 'mz-mindbody-api' ),
            'heading_event'        => __( 'Event', 'mz-mindbody-api' ),
            'heading_location'     => __( 'Location', 'mz-mindbody-api' ),
