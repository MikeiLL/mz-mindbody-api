...
// phpcs:disable
if (!class_exists('MZoo_MzMindbody_WP_Session')) :
    class MZoo_MzMindbody_WP_Session implements ArrayAccess
    {
        public static function get_instance(): MZoo_MzMindbody_WP_Session
        {
            _doing_it_wrong('MZoo_MzMindbody_WP_Session::get_instance', 'Please use native Session functionality.', '3.0');

            return new MZoo_MzMindbody_WP_Session();
        }
