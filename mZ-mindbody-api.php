...
{ // admin actions
	...
	function mz_mindbody_section_text() { ?>
		...
		<p><?php _e('Add to page or post with shortcode')?>: [mz-mindbody-show-schedule (type=day)], [mz-mindbody-show-events], [mz-mindbody-staff-list], [mz-mindbody-login], [mz-mindbody-logout], [mz-mindbody-signup]</p>
	<?php
	}
