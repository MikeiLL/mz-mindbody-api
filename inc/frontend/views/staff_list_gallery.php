...
<div class="col-lg-3 col-md-4 col-xs-6 mz-staff-thumb">
    ...
    data-staffBio="<?php echo $staff->Bio; ?>" href="<?php echo NS\PLUGIN_NAME_URL . 'inc/frontend/views/modals/modal_descriptions.php'; ?>">
...
<div class="modal fade" id="mzStaffModal" tabindex="-1" role="dialog" aria-labelledby="mzSmallModalLabel"
