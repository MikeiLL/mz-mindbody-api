<?php
namespace MZ_Mindbody\Inc\Libraries\WP_Session;
/**
...
add_action( 'plugins_loaded', __NAMESPACE__ . '\\wp_session_start' );
/**
...
add_action( 'shutdown', __NAMESPACE__ . '\\wp_session_write_close' );
/**
...
function wp_session_cleanup() {
	...
	do_action( __NAMESPACE__ . '\\wp_session_cleanup' );
}
add_action( 'wp_session_garbage_collection', __NAMESPACE__ . '\\wp_session_cleanup' );
/**
...
add_action( 'wp', __NAMESPACE__ . '\\wp_session_register_garbage_collection' );