...
CURRENTDIR=$(pwd)
default_svnpath="/tmp/mz-mindbody-api"
default_svnurl="https://plugins.svn.wordpress.org/mz-mindbody-api"
default_svnuser="mikeill"
default_plugindir="$CURRENTDIR"
default_mainfile="mz-mindbody.php"
...
echo "Delete vendor directory and composer.lock if present"

rm -rf vendor composer.lock
echo "Install production composer deps"
# Might be fine to just do `composer install --no-dev`
